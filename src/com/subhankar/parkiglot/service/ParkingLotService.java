package com.subhankar.parkiglot.service;


import com.subhankar.parkiglot.entity.*;
import com.subhankar.parkiglot.repsitory.ParkingLotRepository;
...
public class ParkingLotService {
    ...
    ParkingLotRepository parkingDataRepository;

    public void createParkingLot(ParkingLot parkingLot) {
        vehicleHashMap = new HashMap<>();
        this.parkingLot = parkingLot;
        parkingDataRepository = new ParkingLotRepository();
